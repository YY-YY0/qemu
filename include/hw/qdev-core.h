...
typedef struct DeviceClass {
    ...
    DECLARE_BITMAP(categories, DEVICE_CATEGORY_MAX); //categories琛ㄧず璁惧鐨勭绫伙紝濡侱EVICE_CATEGORY_USB琛ㄧずUSB璁惧锛孌EVICE_CATEGORY_NETWORK琛ㄧず缃戠粶璁惧锛孌EVICE_CATEGORY_DISPLAY琛ㄧず鏄惧崱璁惧
    const char *fw_name;
    const char *desc;
    Property *props;
...
struct DeviceState {
    ...
    const char *id;
    bool realized; //realized琛ㄧず璁惧鏄惁宸茬粡琚叿鐜板寲銆?
    ...
    int alias_required_for_version; // alias_required_for_version鐢ㄤ簬鐑縼绉绘椂锛屽彧鏈夊綋杩欎釜鍊煎ぇ浜庢垨绛変簬璁惧VMStateDescription鐨刴inimum_version_id鍩熸椂璁惧鎵嶈兘杩涜銆?
};
